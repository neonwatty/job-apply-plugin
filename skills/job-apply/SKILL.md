...
- Ordinary application: after Store initialization, read [canonical intake](references/intake.md), then [filling and handoff](references/application.md). Confirm the exact managed resume and its confirmed facts in chat for this job before browser work. A supplied URL is ingested before browser work.
