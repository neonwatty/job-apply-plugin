...
Auto-submit policy is managed only through the inert native policy CLI:

```bash
node "<plugin-root>/runtime/cli/native-final-action-policy.js" status
node "<plugin-root>/runtime/cli/native-final-action-policy.js" activate --input <campaign.json>
node "<plugin-root>/runtime/cli/native-final-action-policy.js" authorize --input <authorization.json>
node "<plugin-root>/runtime/cli/native-final-action-policy.js" claim-final-action \
...
node "<plugin-root>/runtime/cli/native-final-action-policy.js" record-outcome \
...
node "<plugin-root>/runtime/cli/native-final-action-policy.js" kill
node "<plugin-root>/runtime/cli/native-final-action-policy.js" revoke
```
...
This native CLI/service is policy/storage only and never controls a browser. The only executable adapter currently approved is the private isolated-loopback synthetic verifier. Live use remains prohibited until the separately reviewed canary package and exact canary approval.
