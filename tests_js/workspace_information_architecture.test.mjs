...
test('job-apply.synthetic-profile-answers and job-apply.synthetic-resume-extraction-request native Companion behavior for job-apply.synthetic-application-recovery', { timeout: 180000 }, async t => {
