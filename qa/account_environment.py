...
def _compile_native(binary: Path) -> None:
    completed = subprocess.run([
        ...
        str(ROOT / "native/macos/OracleExecutableIdentity.swift"),
        str(ROOT / "native/macos/NativeEmailOnlyBinding.swift"),
        str(ROOT / "native/macos/AccessibilityTree.swift"),
        str(ROOT / "native/macos/ReviewedAccountForm.swift"),
        str(ROOT / "native/macos/OracleBrowserIdentity.swift"),
        str(ROOT / "native/macos/MacOSAccessibilityAccountFlowHelper.swift"),
        str(ROOT / "native/macos/OracleAccountFlowFixtures.swift"),
