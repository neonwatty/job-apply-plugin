...
Ordinary GitHub/source marketplace installs require Python and use the complete Python writer route. Native commands remain limited to prepared-Store and assembled-package rehearsals; source installs do not contain a verified flock addon or provide native Store activation. See [runtime closure status](docs/migration/python-runtime-closure.md).
