...
const FOCUSED = [
  {
    ...
    tests: ['tests_js/raw_json_numeric*.test.mjs', 'tests_js/typed_json*.test.mjs',
      'tests_js/store_validation_ts.test.mjs'],
  },
  {
    id: 'local-typed-json',
    paths: ['src/contracts/raw-json/value.ts', 'src/contracts/raw-json/parser.ts',
      'src/contracts/raw-json/serializer.ts', 'runtime/contracts/raw-json/value.js',
      'runtime/contracts/raw-json/parser.js', 'runtime/contracts/raw-json/serializer.js',
      'tools/contracts/typed-json/**', 'tests_js/typed_json*.test.mjs'],
    tests: ['tests_js/typed_json*.test.mjs', 'tests_js/store_validation_ts.test.mjs'],
  },
  {
    id: 'local-store-validation',
    paths: ['src/store/validation.ts', 'runtime/store/validation.js',
      'tools/contracts/store-validation/**', 'tests_js/store_validation_ts.test.mjs'],
    tests: ['tests_js/store_validation_ts.test.mjs'],
  },
  {
    id: 'local-resume-view',
    paths: ['src/workspace-ui/lib/resume-view.ts', 'runtime/workspace-ui/lib/resume-view.js',
      'tests_js/workspace_resume_view_ts.test.mjs'],
    tests: ['tests_js/workspace_resume_view_ts.test.mjs', 'tests_js/workspace_helpers.test.mjs'],
  },
  {
