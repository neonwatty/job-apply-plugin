...
disabled automatic staging Validate Plugin triggers and required-status checks.
...
automatic staging validation and the aggregate required gate were restored on
2026-09-15.
