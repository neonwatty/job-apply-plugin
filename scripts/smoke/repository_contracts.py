...
def run(root: Path, smoke_root: Path) -> None:
    ...
    expected = {"account-setup", "answer-memory", "application-setup", "job-apply", "job-search", "job-preferences", "job-workspace"}
    ...
    invocation_pattern = re.compile(
        r"(?:\$|/)?job-apply:(account-setup|answer-memory|application-setup|job-apply|job-search|job-preferences|job-workspace)"
    )
