...
PUBLIC_STORE_SIGNATURES = {
    ...
    "_employer_account_flow_decision_locked": "(self, job: 'dict[str, Any]') -> 'dict[str, Any]'",
    "employer_account_flow_decision": "(self, job_id: 'str') -> 'dict[str, Any]'",
    "application_account_flow_plan": "(self, job_id: 'str', platform: 'str') -> 'dict[str, Any]'",
    ...
    "bind_shared_credential_version": "(self, realm_ref: 'str', credential_version: 'int', expected_revision: 'int', *, owner_confirmed: 'bool' = False, public: 'bool' = False) -> 'dict[str, Any]'",
    "begin_shared_credential_upgrade": "(self, realm_ref: 'str', target_version: 'int', expected_revision: 'int', *, owner_confirmed: 'bool' = False) -> 'dict[str, Any]'",
    "complete_shared_credential_upgrade": "(self, operation_id: 'str', outcome: 'str', *, owner_confirmed: 'bool' = False, public: 'bool' = False) -> 'dict[str, Any]'",
    "account_operation_status": "(self) -> 'dict[str, Any]'",
    "recover_account_operation": "(self) -> 'dict[str, Any]'",
    "handoff_application_account_flow": "(self, job_id: 'str', token: 'str', reason: 'str') -> 'dict[str, Any]'",
